...
export default {
  ...
  created() {
    ...
    channel.$on('PageTransitionEvent', data => {
      ...
      if (data.backButtonText) this.backButtonText = data.backButtonText;
      else this.backButtonText = defaultBackButtonText();
      this.showMenuButton = data.showMenuButton;
      this.onMenuButtonClick = data.onMenuButtonClick;
      if (data.menuButtonText) this.menuButtonText = data.menuButtonText;
      else this.menuButtonText = defaultMenuButtonText();
    });
  },
  methods: {
    backButtonClicked(e) {
